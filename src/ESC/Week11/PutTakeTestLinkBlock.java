 ...
 */
public class PutTakeTestLinkBlock {
    ...
    public static void main(String[] args) throws Exception {
        new PutTakeTestLinkBlock(10, 10, 100000).test(); // sample parameters
        pool.shutdown();
    }

    public PutTakeTestLinkBlock(int capacity, int npairs, int ntrials) {
