...
/**
 * Created by HanWei on 7/4/2017.
 */
public class PutTakeTestArrayBlock {
    ...
    public static void main(String[] args) throws Exception {
        new PutTakeTestArrayBlock(10, 10, 100000).test(); // sample parameters
        pool.shutdown();
    }

    public PutTakeTestArrayBlock(int capacity, int npairs, int ntrials) {
